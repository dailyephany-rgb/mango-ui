...
export default function MasterAdminPanel() {
  ...
  const [routingMap, setRoutingMap] = useState([]); // RESTORED ROUTING STATE
      ...
      json.forEach(row => {
        ...
        if (!groupedHospital[diagNo]) {
          groupedHospital[diagNo] = {
            ...
            hospitalTests: [],      // Original names
            expectedLabTests: [],   // Converted names for logic
            convertedDisplay: []    // Combined list for display
          };
        }
        ...
        // Revised Logic: Find mapping or keep original
        ...
        if (!labMatch) {
          ...
          if (missingTests.length > 0) {
            mismatch.push({ 
              hospital: hRow, 
              lab: labMatch, 
              hTests: hRow.convertedDisplay.join(", "), // Shows converted + non-converted
